    ...
    <div>
      ...
      <div class="header">
        ...
        <transition name="fullSearch">
          <nav v-if="!displaySearch" class="search-container" :class="details"
            ...
            <div class="search-area destinations">
              <span class="search-area-text">{{ locationFilter }}
              </span>
            </div>
            <div class="vl"></div>
        ...
        <div class="user-settings-container">
          ...
          <div class="user-section user-btn" @click="dropOpen = !dropOpen">
...
export default {
  ...
  computed: {
    ...
    headerClass() {
      const isDetailsHeader = this.$route.name === 'stay-details' || this.$route.name === 'host'
